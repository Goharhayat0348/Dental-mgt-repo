                    ...
                    if (txtNewPasword.Text==txtConfirmPasword.Text)
                    {
                        ...
                        if (!string.IsNullOrEmpty(txtEmail.Text)&&!string.IsNullOrEmpty(txtPassword.Text)&&!string.IsNullOrEmpty(txtNewPasword.Text)&&!string.IsNullOrEmpty(txtConfirmPasword.Text))
                        {
                            ...
                            if (dt.Rows.Count>0) 
                            {
                                ...
                                Log.ClinicId = Convert.ToInt32(dt.Rows[0]["ClinicId"].ToString());
                                Log.Email = Convert.ToString(dt.Rows[0]["Email"].ToString());
                                //Log.AccountType = Convert.ToString(dt.Rows[0]["AccountType"].ToString());
                                ...
                                Clear();
                               lg.SaveLog ("" + dt.Rows[0]["Email"].ToString() + "Has Change their Password");
                            }
                            else
                            {
